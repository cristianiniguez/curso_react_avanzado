      ...
      >
        <defs>
          ...
          >
            ...
            <stop offset={1} stopColor='#3000ff' />
          </linearGradient>
          <filter id='prefix__editing-gradow-filter' x='-100%' y='-100%' width='300%' height='300%'>
            <feFlood floodColor='#cbcab9' result='flood' />
            <feComposite operator='in' in2='SourceAlpha' in='flood' result='shadow' />
            <feOffset dx={-4.1} dy={-4} in='SourceGraphic' result='offset-1' />
            <feOffset dx={4.1} dy={4} in='shadow' result='offset-2' />
            <feMerge>
